...
/*Se hace una regresión entre las amenidades del barrio y el cambio del número de habitantes en ocupaciones de altas habilidades respecto a bajas habilidades sumado a nivel tract. Se están utilizando efectos fijos de área metropolitana para controlar por todas las características no observables invariantes en el tiempo del área. Estas indican que manteniendo constante las características del área invariantes, la relación de aumentar la proporción de personas calificadas en el tract en el crecimiento de las amenidades es positivo. Se utilizan errores estándares robustos por posible heterocedasticidad de los errores estándares. El autor utiliza para el crecimiento de la habilidad su variable instrumental ya que quiere evaluar cual es el efecto de que las personas migren al tract por cambios en el valor del tiempo y ubicación de sus trabajos, y no por otras razones. Aún así podría haber endogeneidad porque pueden haber variables  tales como el valor de la renta de un lugar que influyan en la ubicación de los trabajos que hacen que haya más amenidades y que la gente de alta calificación migre  */
*************************************+*************************************+**
